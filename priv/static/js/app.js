...
function update_buttons() {
  (0, _jquery2.default)('.start-button').each(function (_, bb) {
    var task_id = (0, _jquery2.default)(bb).data('task-id');
    var flag = (0, _jquery2.default)(bb).data('flag');
    if (flag == 0) {
      (0, _jquery2.default)(bb).text("Stop task");
    } else {
      (0, _jquery2.default)(bb).text("Start automated task tracker");
    }
  });
}
...
function set_button(task_id, value) {
  (0, _jquery2.default)('.start-button').each(function (_, bb) {
    if (task_id == (0, _jquery2.default)(bb).data('task-id')) {
      (0, _jquery2.default)(bb).data('flag', value);
    }
  });
  update_buttons();
}
...
function endtask(task_id) {
  ...
  console.log(text);
  _jquery2.default.ajax(timestamp_path, {
    method: "post",
    dataType: "json",
...
function init_start() {
  console.log("hi");
  if (!(0, _jquery2.default)('.start-button')) {
    return;
  }

  (0, _jquery2.default)(".start-button").click(start_click);
